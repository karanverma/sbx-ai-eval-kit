...
The following verification output is included as an illustrative example of the evaluation workflow. It is not generated by this repository.
...
This worked example follows the structure described in the [Sample Evaluation Workflow](./sample-evaluation-workflow.md).
